...
```{r}
traincsv <- read.csv("C://Users//ronit//Downloads//data//pml-training.csv")
testcsv <- read.csv("C://Users//ronit//Downloads//data//pml-testing.csv")
dim(traincsv)
dim(testcsv)
```
...
Github Repo: [Github](https://github.com/Saabu/Course_Project_Practical_Machine_Learning)
